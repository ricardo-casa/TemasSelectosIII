...
// Rotar
struct Rotar_tA875FF4C58D261894AAB73C9DDED9B1AE0E27560;
...
// Rotar
struct Rotar_tA875FF4C58D261894AAB73C9DDED9B1AE0E27560  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	// System.Single Rotar::velocidadRotacion
	float ___velocidadRotacion_4;
	// UnityEngine.Transform Rotar::pivote
	Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* ___pivote_5;
};
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Rotar_Update_mE7A3B1BC452D8B1316DE35E451AB9DB52900F556 (Rotar_tA875FF4C58D261894AAB73C9DDED9B1AE0E27560* __this, const RuntimeMethod* method) 
{
	{
		// this.transform.RotateAround(pivote.transform.position, Vector3.up, velocidadRotacion*Time.deltaTime) ;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_0;
		L_0 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_1 = __this->___pivote_5;
		NullCheck(L_1);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_2;
		...
		float L_5 = __this->___velocidadRotacion_4;
		float L_6;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Rotar__ctor_m556D3F78406F5D456A944AA25C5B9D5EEB6AC59C (Rotar_tA875FF4C58D261894AAB73C9DDED9B1AE0E27560* __this, const RuntimeMethod* method) 
{
	{
		// public float velocidadRotacion = 20.0f;
		__this->___velocidadRotacion_4 = (20.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
